...
Tree.prototype.createSearchBar = function (parentNode) {
  ...
  var searchNode = Util.dom.createNode('input', { class: 'search', placeholder: 'Buscar...' });
...
exports.createSelected = function (astItem, disableRemoval, showSectionOnSelected) {
  ...
  if (!disableRemoval && !astItem.disabled) {
    var removalSpan = exports.createNode('span', { style: 'background-color:red;', class: 'remove-selected', text: 'X' });
