...
<?php include_once('navbar.php'); ?>
 <div style="display:flex; justify-content: center; margin:2%; margin-top:7em;" class="container-sm" >
            ...
            <form  method="post" action="" onSubmit="return valida_dados(this)" enctype="multipart/form-data">
                ...
                CAMPOS DE EDIÇÃO DE TITULOS E ASSUNTO PARA ALTERAR O VIDEO INATIVE <BR>
                O POSTE ATUAL E REALIZE UM NOVO POST COM O VIDEO CORREÇÕES.
                </div>
                <div class="mb-4">
                <label style="background-color: none; width:none; color: none;" for="titulo">Titulo:</label>
                <input class="bordas-inputs" value='<?=$video['titulo']?>' type="text" id="titulo" name="titulo" maxlength="80">
                </div>
                  <!---->
                  <div class="mb-2">
                ...
                <!---->
                <div class="mb-4">
                <label style="background-color: none; width:none; color: none;" for="tipo">Tipo:</label>
                ...
                <div class="mb-4">
                <label style="background-color: none; width:none; color: none;" for="tempo">Duração:</label>
...
<script src="validar_campos.js"></script>
</body>
</html>