        ...
        <div  id="my-nav"  class="collapse navbar-collapse">
          <ul style="display: flex; align-items: center;" class="navbar-nav mr-auto">
            ...
            foreach ($Lista as $user){
              if($_SESSION['matricula'] == $user[1]){ $cont =1; }// compara se ah usuarios com permissão para visualizar a opção postar
            }

              if($cont!=0){// caso o contador for diferente de 0 é pq ele encontrou alguem dentro da busca 
