...
session_start();
$conterro = 0;
if (isset($_SESSION['matricula']) && isset($_SESSION['set_usuario'])) {
   if ($_FILES['arquivo']['error'] == NULL) {
      ...
      if ($conterro != 0 && $conterro == 'E') { // if de verificação erro de extensão
         ...
         $arquivo->adicionar_video($nome_atual, $diretorio, $_POST['descricao'], $_POST['titulo'], $_POST['assunto'], $_POST['tipo'], $_POST['subtipo'], $_POST['tempo']);
...
}// if tratamento de erro de sessão
//
